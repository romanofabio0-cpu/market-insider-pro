...
def run_advanced_tests():
    ...
    public_dir = "public"  # O OUTPUT_FOLDER se configurato diversamente, ma usiamo la cartella dove si generano i file
    
    # Fallback se la cartella si chiama in altro modo nel tuo setup (es. la cartella corrente)
    ...
    # TEST 4: BROKEN LINKS (Link Rotti interni)
    ...
    for file in html_files:
        ...
        with open(filepath, 'r', encoding='utf-8') as f:
            content = f.read()
            # Trova tutti gli href locali (che finiscono in .html)
    ...
    try:
        # Simuliamo una mini-chiamata per testare la latenza e i blocchi
