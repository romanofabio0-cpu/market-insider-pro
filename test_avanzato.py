...
def run_advanced_tests():
    ...
    for file in html_files:
        ...
        with open(filepath, 'r', encoding='utf-8') as f:
            ...
            for link in links:
                # LA MAGIA: Ignora i link della CNBC e dei giornali esterni
    ...
    if broken_links == 0:
        print("   ✅ Perfetto! Nessun link rotto trovato. Navigazione sicura al 100%.")

    # TEST 5: AFFILIATE TRACKING
    print("\n💰 TEST 5: Verifica Presenza Affiliate Links...")
    ...
    if os.path.exists(academy_file):
        with open(academy_file, 'r', encoding='utf-8') as f:
            if "mip081-21" in f.read():
                print("   ✅ Tag Affiliato Amazon rilevato e blindato nei bottoni!")
            else:
                print("   ❌ ATTENZIONE: Tag affiliato non trovato nell'Academy.")
    else:
        print("   ⚠️ File Academy_lez1_1.html non trovato.")

    # TEST 6: BINANCE API PING
    print("\n📡 TEST 6: Ping Server Binance (Motore Prezzi)...")
    try:
        req = urllib.request.urlopen("https://api.binance.com/api/v3/ticker/price?symbol=BTCUSDT", timeout=5)
        if req.getcode() == 200:
            print("   ✅ Connessione a Binance stabilita! Feed dei prezzi live operativo.")
