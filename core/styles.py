...
.nav a { margin-left: 20px; font-size: 0.9rem; color: #888; font-weight: 500; }
.nav a.active, .nav a:hover { color: #fff; }
.vip-btn { background: var(--accent); color: #fff; padding: 8px 16px; border-radius: 4px; font-weight: 700; font-size: 0.8rem; }
