        ...
        "lessons": [
            {
                ...
                "vip": True, 
                "html": f'''
                <h1 style="color:#fff; font-size:2.5rem; margin-bottom:10px; font-weight:900;">System Integration</h1>
                ...
                <div style='margin-top:40px; padding:30px; background:#1a1a1a; border-left:4px solid #FF9900; border-radius:4px;'>
        ...
        "lessons": [
            {
                ...
                "vip": True, 
                "html": f'''
                <h1 style="color:#fff; font-size:2.5rem; margin-bottom:10px; font-weight:900;">Delta Neutral Strategies</h1>
                ...
                <div style='margin-top:40px; padding:30px; background:#1a1a1a; border-left:4px solid #2962FF; border-radius:4px;'>
...
def build_signals_page(assets: List[Dict]):
    ...
    for a in hot_assets:
        ...
        <tr style="border-bottom: 1px solid #111;">
            ...
            <td style="padding:15px; font-weight:bold; font-size:0.9rem;" class="{css}">{sig}</td>
